...
def Cntl(d_fr, d_lh, d_rh):
    ...
    if d_fr < 20:
        ...
        if d_lh > 140 or d_rh < 30:
            ...
            # タイヤを前進方向に回転させる
            if time.time() - time_of_starting_to_turn_l < CORNERING_TIME :
            ...
            # タイヤを前進方向に回転させる
            if time.time() - time_of_starting_to_turn_r < CORNERING_TIME :
                pwm.set_pwm(SPEED, 0, PWM_FORWARD_MID)
            else :
                pwm.set_pwm(SPEED, 0, PWM_FORWARD_MIN)
        else:
            ...
            if 100 < d_fr :
                ...
                pwm.set_pmw(SPEED, 0, PWM_FORWARD_MIN)
        return True
